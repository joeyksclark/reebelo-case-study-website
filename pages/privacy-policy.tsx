...
const PrivacyPolicyPage: React.FC = () => {
    return (
        <div>
            ...
            <h2>We Don&lsquot Know What You Had for Breakfast (Or Do We???)</h2>
            ...
            <p>
                *Actually, it&lsquos not, have you seen the API? We use the latest technology to protect no data from hackers, aliens, and anyone else who might be interested in it.
            </p>

            <h2>Cookies (The Delicious Kind)</h2>

            <p>
                We don&lsquot use cookies on our website to track your preferences or provide you with a better browsing experience.
            </p>

            <h1>BUT SERIOUSLY, DON&lsquoT ENTER ANY PERSONAL INFORMATION</h1>
